...
\item It's declarative and supports both static and demand evaluation
}
...
\note[itemize]{
\item This is a list of other tools that try to help with program analysis in a declarative way without the use of attribute grammars
}