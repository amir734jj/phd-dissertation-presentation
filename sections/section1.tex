...
\note[itemize]{
\item As a motivation, given this simple arithmetic expression, lets utilize attribute grammars to define semantics of its final value
\item but first lets construct a context-free grammar for it
}
...
\note[itemize]{
\item This is a context-free grammar describing that arithmetic expression with a correct order of operation
...
\note[itemize]{
\item This is a an attribute grammar describing the value of each expression
\item Notice propagation of attribute values are always bottom-up
\item val is a synthesized attribute
...
\note[itemize]{
\item This is a list of highly influential papers that contributed to the field of attribute grammars and we will be building upon them
\item Starting from Knuth 1968 paper titled "Semantics of Context-Free Languages"
\item And most recently Hedin in 2007 introduced an extension to Knuth's classical attribute grammar called circular remote attribute grammars 
}
...
\note[itemize]{
\item What is the end-goal of this thesis and how do we measure whether our hypothesis actually works or not?
\item So, the goal is statically scheduling circular remote attribute grammars
\item To validate our work is actually working, we will modify APS attribute grammar system and test it against common circularly defined problems over a tree
}
...
\item As far as we are aware of, This has NOT been done before
\item Not even static evaluator for circular attribute grammars
\item And it brings over static schedule to the circular remote attribute grammars which is the most accommodating extension of attribute grammars
}