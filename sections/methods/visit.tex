...
\item And then we need to make sure protocol start and end with non-circular phase, if there is none then we can just stick an empty non-circular phase at the start or end
