...
\note[itemize]{
\item But the whole fiber cycle breaking change turned out to be fruitless and not needed because fiber cycles are monotone and can be handled by the CRAG static scheduler
